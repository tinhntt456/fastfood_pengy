      ...
      <div class="col">
        <div class="footer-widget-7">
          ...
          <ul class="widget-link list-unstyled">
            <li><a href="javascript:;">🍔 Burgers</a></li>
            <li><a href="javascript:;">🍟 Fries</a></li>
            <li><a href="javascript:;">🍗 Fried Chicken</a></li>
            <li><a href="javascript:;">🥤 Drinks</a></li>
            <li><a href="javascript:;">🍰 Desserts</a></li>
            <li><a href="javascript:;">🥙 Combos</a></li>
            <li><a href="javascript:;">👶 Kids Meal</a></li>
          </ul>
        </div>
      </div>
      <div class="col">
      ...
      <div class="col">
        <div class="footer-widget-9">
          ...
          <div class="mb-4 mt-4">
            ...
            <p class="mb-0 text-muted">support@fastfood.com</p>
          </div>
          <div class="">
            <h5 class="mb-0 fw-bold">Toll Free</h5>
            <p class="mb-0 text-muted">1800-7898-3465</p>
          </div>
        </div>
      </div>
    </div><!--end row-->
